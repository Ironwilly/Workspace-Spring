...
public class MainController {
	...
	//para trabajar con ellos e incluso poder emitir una respuesta que dependa de los parámetros que hemos obtenido
	...
	public String index(@RequestParam(name="idCategoria", required=false) Long idCategoria, Model model) {		
		...
		/*Si la categoría no es nula, obtenemos 8 productos aleatoriamente, si es nula obtenemos todos los de 
	 ...
	 * Atiend3 a la petición de /product/id del producto sobre el que se ha hecho click
	 * Al hacer click sobre el producto, se recoge el id y es el que tenemos en la ruta de getMapping
